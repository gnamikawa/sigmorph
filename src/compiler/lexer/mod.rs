// START -> SCOPE
// SCOPE -> VARIABLE_DECLARATION | EVENT_DECLARATION | ASSIGNMENT | SCOPE
// DECLARATION -> (EVENT | VARIABLE);
//
// ASSIGNMENT -> VARIABLE_IDENTIFIER = EXPRESSION;
// LHS_OPERAND -> VARIABLE_IDENTIFIER | CONST_IDENTIFIER
// RHS_OPERAND -> VARIABLE_IDENTIFIER | CONST_IDENTIFIER | NUMERIC_LITERAL
// EXPRESSION -> LHS_OPERAND OPERATION RHS_OPERAND | RHS_OPERAND
//
// OPERATION -> + | - | * | /
//
// EVENT_DECLARATION -> event CONST_IDENTIFIER;
// VARIABLE_DECLARATION -> const ASSIGNMENT;
//
